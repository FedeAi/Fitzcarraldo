...
//oggetto dell'email
$oggetto_email = "Modulo Pre-iscrizione Trofeo Jack Holt";
...
$pagina_error_referer = "frame_trofeojholt_inviook.html";
...
if($obbligo_email == "y"){
    ...
    if(isset($_POST['email'])){
        ...
        //espressione regolare a cura dell'esimio dottore - http://www.myphp.it
...
Modulo preiscrizione al Trofeo Jack Holt";
