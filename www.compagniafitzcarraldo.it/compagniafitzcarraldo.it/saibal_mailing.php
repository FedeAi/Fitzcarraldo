...
$destinatario = "segreteria@compagniafitzcarraldo.it";

//nome mittente per la corretta intestazione del modulo
$nome_mittente = "Sito Compagnia delle Derive Fitzcarraldo";

//email mittente per la corretta intestazione del modulo
$email_mittente = "segreteria@compagniafitzcarraldo.it";

//oggetto dell'email
$oggetto_email = "Iscrizione mailing list dal sito della Compagnia delle Derive Fitzcarraldo";
...
$pagina_error_referer = "frame_mailing_list_inviook.html";
...
Modulo iscrizione mailing list dal sito della Compagnia delle Derive Fitzcarraldo";
