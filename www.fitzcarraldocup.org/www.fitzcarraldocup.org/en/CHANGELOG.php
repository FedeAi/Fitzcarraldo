...
30-Nov-2005 Marco Bertolini (Vamba)
 @ Corretti alcuni errori di traduzione segnalati
 @ Corretto problema visulizzazione paramentri componente syndicate
 @ Corretti e modificati termini impropri o errati nella traduzione italiana
...
25-Sep-2005 Marco Bertolini (Vamba)
+  Controllo traduzione italiana
...
25-Sep-2005 TTI joomla.it
^ Inzio traduzione in lingua italiana

25-Sep-2005 Marco Bertolini (Vamba)
^ Licenza in istallazione in lingua italiana
@ Fixed Alcuni errori di traduzione segnalati
# Fixed artf1218 Search non includeva i weblinks

25-Sep-2005 Steven Spignataro
# Fixed artf1219 Component module dispay error

24-Sep-2005 Rey Gigataras
 ^ artf1214 : pastarchives.jpg seems unintuitive.

23-Sep-2005 Marco Bertolini (Vamba)
 @ Fixed Alcuni errori di traduzione segnalati
 @ Fixed Segnalazione_0003 errore menu manager con PHP5
...
22-Sep-2005 Marco Bertolini (Vamba)
 @ Fixed Alcuni errori di traduzione segnalati
 @ Fixed Segnalazione_0002 : Problema Bottone Cestino non segnalava la non selezione dalla lista
 @ Fixed Segnalazione_0001 : Admin Config - selezioni Nascondi/Mostra invertite


21-Sep-2005 Marco Bertolini aka Vamba
 + italian backend & frontend language
