...
<html>
<head>
	<title>Anteprima sondaggio</title>
...
<table align="center" width="90%" cellspacing="2" cellpadding="2" border="0" >
	...
	<tr>
		<td valign="middle" height="50" colspan="2" align="center"><input type="button" name="submit" value="Vota">&nbsp;&nbsp;<input type="button" name="result" value="Risultati"></td>
	</tr>
	<tr>
		<td align="center" colspan="2"><a href="#" onClick="window.close()">Chiudi</a></td>
	</tr>
</table>
</form>
</body>
