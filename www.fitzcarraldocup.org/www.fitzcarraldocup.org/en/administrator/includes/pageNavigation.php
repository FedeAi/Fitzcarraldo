...
class mosPageNav {
	...
	*/
	function getPagesCounter() {
		...
		if ($this->total > 0) {
			$html .= "\nRisultati " . $from_result . " - " . $to_result . " di " . $this->total;
		} else {
	...
	*/
	function getPagesLinks() {
		...
		if ($this_page > 1) {
			...
			$html .= "\n<a href=\"#beg\" class=\"pagenav\" title=\"Prima pagina\" onclick=\"javascript: document.adminForm.limitstart.value=0; document.adminForm.submit();return false;\"><< Inizio</a>";
			$html .= "\n<a href=\"#prev\" class=\"pagenav\" title=\"precedente\" onclick=\"javascript: document.adminForm.limitstart.value=$page; document.adminForm.submit();return false;\">< Precedente</a>";
		} else {
			$html .= "\n<span class=\"pagenav\"><< Inizio</span>";
			$html .= "\n<span class=\"pagenav\">< Precedente</span>";
		}
		...
		if ($this_page < $total_pages) {
			...
			$html .= "\n<a href=\"#next\" class=\"pagenav\" title=\"prossima pagina\" onclick=\"javascript: document.adminForm.limitstart.value=$page; document.adminForm.submit();return false;\"> Prossima ></a>";
			$html .= "\n<a href=\"#end\" class=\"pagenav\" title=\"fine pagina\" onclick=\"javascript: document.adminForm.limitstart.value=$end_page; document.adminForm.submit();return false;\"> Fine >></a>";
		} else {
			$html .= "\n<span class=\"pagenav\">Prossima ></span>";
			$html .= "\n<span class=\"pagenav\">Fine >></span>";
		}
		return $html;
	}
	...
	function getListFooter() {
		...
		$html .= '</th></tr><tr>';
		$html .= '<td nowrap="true" width="48%" align="right">Mostra #</td>';
...
* @return string
*/
	function orderUpIcon( $i, $condition=true, $task='orderup', $alt='Sposta su' ) {
...
* @return string
*/
	function orderDownIcon( $i, $n, $condition=true, $task='orderdown', $alt='Sposta gi&ugrave;' ) {
