...
class mosMenuBar {
	...
	*/
	function custom( $task='', $icon='', $iconOver='', $alt='', $listSelect=true ) {
		...
		if ($listSelect) {
			$href = "javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da $alt');}else{submitbutton('$task')}";
		} else {
	...
	*/
	function customX( $task='', $icon='', $iconOver='', $alt='', $listSelect=true ) {
		...
		if ($listSelect) {
			$href = "javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da $alt');}else{hideMainMenu();submitbutton('$task')}";
		} else {
	...
	*/
	function addNew( $task='new', $alt='Nuovo' ) {
	...
	* @param string An override for the alt text
	*/
	function addNewX( $task='new', $alt='Nuovo' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'new_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
	...
	* @param string An override for the alt text
	*/
	function publish( $task='publish', $alt='Pubblica' ) {
	...
	* @param string An override for the alt text
	*/
	function publishList( $task='publish', $alt='Pubblica' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'publish_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
	 	<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da pubblicare'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
	 	<?php
	...
	* @param string An override for the alt text
	*/
	function makeDefault( $task='default', $alt='Predefinito' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'publish_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da rendere predefinito'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function assign( $task='assign', $alt='Assegna' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'publish_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da assegnare'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function unpublish( $task='unpublish', $alt='Sospendi' ) {
	...
	* @param string An override for the alt text
	*/
	function unpublishList( $task='unpublish', $alt='Sospendi' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'unpublish_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da non pubblicare'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function archiveList( $task='archive', $alt='Archivia' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'archive_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da archiviare'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function unarchiveList( $task='unarchive', $alt='Ripristina' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'unarchive_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da ripristinare'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function editList( $task='edit', $alt='Modifica' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'edit_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da modificare'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function editListX( $task='edit', $alt='Modifica' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'edit_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da modificare'); } else {hideMainMenu();submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function editHtml( $task='edit_source', $alt='Mod.&nbsp;HTML' ) {
	...
	* @param string An override for the alt text
	*/
	function editHtmlX( $task='edit_source', $alt='Mod.&nbsp;HTML' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'html_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da modificare'); } else {hideMainMenu();submitbutton('<?php echo $task;?>', '');}"">
	...
	* @param string An override for the alt text
	*/
	function editCss( $task='edit_css', $alt='Mod.&nbsp;CSS' ) {
	...
	* @param string An override for the alt text
	*/
	function editCssX( $task='edit_css', $alt='Mod.&nbsp;CSS' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'css_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da modificare'); } else {hideMainMenu();submitbutton('<?php echo $task;?>', '');}">
	...
	* @param string An override for the alt text
	*/
	function deleteList( $msg='', $task='remove', $alt='Cancella' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'delete_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da cancellare'); } else if (confirm('Sei sicuro di voler cancellare gli elementi selezionati? <?php echo $msg;?>')){ submitbutton('<?php echo $task;?>');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function deleteListX( $msg='', $task='remove', $alt='Cancella' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'delete_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		?>
		<td>
		<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una scelta dalla lista da cancellare'); } else if (confirm('Sei sicuro di voler cancellare gli elementi selezionati? <?php echo $msg;?>')){ hideMainMenu();submitbutton('<?php echo $task;?>');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	*/
	function trash( $task='remove', $alt='Cestina', $check=true ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'delete_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1 );
		
		if ( $check ) {
			$js = "javascript:if (document.adminForm.boxchecked.value == 0){ alert('Effettuare una selezione dalla lista da Cestinare'); } else { submitbutton('$task');}";
		} else {
	...
	*/
	function preview( $popup='', $updateEditors=false ) {
		global $database;
		$image2 = mosAdminMenus::ImageCheckAdmin( 'preview_f2.png', '/administrator/images/', NULL, NULL, 'Anteprima', 'preview', 1 );
	...
	*/
	function help( $ref, $com=false ) {
		...
		$image2 	= mosAdminMenus::ImageCheckAdmin( 'help_f2.png', '/administrator/images/', NULL, NULL, 'Aiuto', 'help', 1 );
	...
	* @param string An override for the alt text
	*/
	function apply( $task='apply', $alt='Applica' ) {
	...
	* @param string An override for the alt text
	*/
	function save( $task='save', $alt='Salva' ) {
	...
	*/
	function savenew() {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'save_f2.png', '/administrator/images/', NULL, NULL, 'salva', 'save', 1 );
		?>
		<td>
	...
	* @param string An override for the alt text
	*/
	function cancel( $task='cancel', $alt='Annulla' ) {
	...
	* any other operation
	*/
	function back( $alt='Indietro', $href='' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'back_f2.png', '/administrator/images/', NULL, NULL, 'indietro', 'cancel', 1 );
		if ( $href ) {
			$link = $href;
		} else {
	...
	*/
	function media_manager( $directory = '', $alt='Carica' ) {
		global $database, $mainframe;
		
		$cur_template = $mainframe->getTemplate();
		
		$image2 = mosAdminMenus::ImageCheckAdmin( 'upload_f2.png', '/administrator/images/', NULL, NULL, 'Carica immagine', 'uploadPic', 1 );
		?>
		<td>
